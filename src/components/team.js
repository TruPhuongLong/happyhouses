        ...
        <div className="container">
            ...
            <div className="row">
                ...
                <div className="col-md-3">
                    <div className="team-item">
                        <div className="team-image">
                            <img src="images/demo/author-2.jpg" className="img-responsive" alt="author" />
                        </div>
                ...
                <div className="col-md-3">
                    <div className="team-item">
                        <div className="team-image">
                            <img src="images/demo/author-6.jpg" className="img-responsive" alt="author" />
                        </div>
                        <div className="team-text">
                            <h3>LINA GOSATA</h3>
                ...
                <div className="col-md-3">
                    <div className="team-item">
                        <div className="team-image">
                            <img src="images/demo/author-3.jpg" className="img-responsive" alt="author" />
                        </div>
                        <div className="team-text">
                            <h3>Larry Parker</h3>
                ...
                <div className="col-md-3">
                    <div className="team-item">
                        <div className="team-image">
                            <img src="images/demo/author-4.jpg" className="img-responsive" alt="author" />
                        </div>
                        <div className="team-text">
                            <h3>John BEKERS</h3>
